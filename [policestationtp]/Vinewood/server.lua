...
local policeStationCoords = vector3(649.5, -10.5, 82.7) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("Vinewood"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Vinewood police station.",}, color = {0, 255, 0}})
