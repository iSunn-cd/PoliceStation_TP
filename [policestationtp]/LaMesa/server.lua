...
local policeStationCoords = vector3(825.9, -1290.0, 28.2) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("LaMesa"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Mesa police station.",}, color = {0, 255, 0}})
