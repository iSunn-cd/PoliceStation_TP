...
local policeStationCoords = vector3(-1093.7, -808.8, 19.2) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("Vespucci"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Vespucci police station.",}, color = {0, 255, 0}})
