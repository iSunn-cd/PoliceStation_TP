...
local policeStationCoords = vector3(431.9140, -982.0182, 30.7054) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("missionrow"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Mission Row police station.",}, color = {0, 255, 0}})
