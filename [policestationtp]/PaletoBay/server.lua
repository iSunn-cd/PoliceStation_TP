...
local policeStationCoords = vector3(-442.0, 6017.8, 31.6) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("PaletoBay"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Paleto Bay police station.",}, color = {0, 255, 0}})
