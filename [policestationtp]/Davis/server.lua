...
local policeStationCoords = vector3(360.1, -1584.0, 29.2) -- Remplacez par les coordonnées souhaitées
...
RegisterCommand(string.lower("Davis"), function(source)
    -- ...
  ...
  if GetPlayerPed(source) ~= 0 then
    ...
    TriggerClientEvent("chat:addMessage", source, {args = {"You are teleported to the Sheriff Davis police station.",}, color = {0, 255, 0}})
